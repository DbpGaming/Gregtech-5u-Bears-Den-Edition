            ...
            for (int i = 3; i < aRecipe.length; i++) {
                ...
                if (aRecipe[i] == X.PLATE) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.plate.get(Materials.get("Steel"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.plate.get(Materials.get("Aluminium"));
                            break;
                        case 3:
                            aRecipe[i] = OrePrefixes.plate.get(Materials.get("StainlessSteel"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.plate.get(Materials.get("Titanium"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.plate.get(Materials.get("TungstenSteel"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.PIPE) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.pipeMedium.get(Materials.get("Bronze"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.pipeMedium.get(Materials.get("Steel"));
                            break;
                        case 3:
                            aRecipe[i] = OrePrefixes.pipeMedium.get(Materials.get("StainlessSteel"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.pipeMedium.get(Materials.get("Titanium"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.pipeMedium.get(Materials.get("TungstenSteel"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.COIL_HEATING) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("AnyCopper"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("Cupronickel"));
                            break;
                        case 3:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("Kanthal"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("Nichrome"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.wireGt08.get(Materials.get("Nichrome"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.COIL_HEATING_DOUBLE) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.wireGt04.get(Materials.get("AnyCopper"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.wireGt04.get(Materials.get("Cupronickel"));
                            break;
                        case 3:
                            aRecipe[i] = OrePrefixes.wireGt04.get(Materials.get("Kanthal"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.wireGt04.get(Materials.get("Nichrome"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.wireGt16.get(Materials.get("Nichrome"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.STICK_DISTILLATION) {
                    switch (mTier) {
                        default:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("Blaze"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.STICK_MAGNETIC) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("IronMagnetic"));
                            break;
                        case 2:
                        case 3:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("SteelMagnetic"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("NeodymiumMagnetic"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.STICK_ELECTROMAGNETIC) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("AnyIron"));
                            break;
                        case 2:
                        case 3:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("Steel"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("Neodymium"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.stick.get(Materials.get("VanadiumGallium"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.COIL_ELECTRIC) {
                    switch (mTier) {
                        case 0:
                            aRecipe[i] = OrePrefixes.wireGt01.get(Materials.get("Tin"));
                            break;
                        case 1:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("Tin"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.wireGt02.get(Materials.get("AnyCopper"));
                            break;
                        case 3:
                            ...
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.wireGt08.get(Materials.get("AnnealedCopper"));
                            break;
                        default:
                            aRecipe[i] = OrePrefixes.wireGt16.get(Materials.get("AnnealedCopper"));
                            break;
                    }
                    continue;
                }
                ...
                if (aRecipe[i] == X.ROTOR) {
                    switch (mTier) {
                        case 0:
                        case 1:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("Tin"));
                            break;
                        case 2:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("Bronze"));
                            break;
                        case 3:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("Steel"));
                            break;
                        case 4:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("StainlessSteel"));
                            break;
                        case 5:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("TungstenSteel"));
                            break;
                        case 6:
                            aRecipe[i] = OrePrefixes.rotor.get(Materials.get("TungstenSteel"));
                            break;
