...
public class GT_Spray_Ice_Item extends GT_Tool_Item {
    public GT_Spray_Ice_Item(String aUnlocalized, String aEnglish, int aMaxDamage, int aEntityDamage) {
        ...
        for (Object tName : Arrays.asList(OrePrefixes.bucket.get(Materials.get("Water")), OrePrefixes.cell.get(Materials.get("Water")), OrePrefixes.capsule.get(Materials.get("Water")))) {
