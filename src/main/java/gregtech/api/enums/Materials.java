...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Force = new Materials(-1, TextureSet.SET_DIAMOND, 10.0F, 128, 3, 1|2|4|8 |64|128, 255, 255, 0, 0, "Force", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeYellow, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 5)));
    ...
    public static Materials SulfurDioxide   = new Materials(795, TextureSet.SET_FLUID, 1.0F, 0, 2, 16, 186, 155, 46, 0, "Sulfur Dioxide", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeYellow, 1, Arrays.asList(new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 2)));
    ...
    public static Materials PurpleAlloy = new Materials(521, TextureSet.SET_DULL, 1.0F, 0, 0, 1 | 2, 225, 80, 232, 0, "Purple Alloy", 0, 0, -1, 0, false, false, 3, 5, 1, Dyes.dyePurple, 2, Arrays.asList(new MaterialStack(BlueAlloy, 1), new MaterialStack(RedAlloy, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 3)));
