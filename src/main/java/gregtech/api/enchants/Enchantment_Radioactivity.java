...
public class Enchantment_Radioactivity extends EnchantmentDamage {
    ...
    public Enchantment_Radioactivity() {
        ...
        Materials.get("Plutonium").setEnchantmentForTools(this, 1).setEnchantmentForArmors(this, 1);
        Materials.get("Uranium235").setEnchantmentForTools(this, 2).setEnchantmentForArmors(this, 2);
        Materials.get("Plutonium241").setEnchantmentForTools(this, 3).setEnchantmentForArmors(this, 3);
        Materials.get("NaquadahEnriched").setEnchantmentForTools(this, 4).setEnchantmentForArmors(this, 4);
        Materials.get("Naquadria").setEnchantmentForTools(this, 5).setEnchantmentForArmors(this, 5);
        INSTANCE = this;
    }
