...
public class GT_RecipeAdder
    ...
    public boolean addAlloySmelterRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aOutput1, int aDuration, int aEUt) {
        if ((aInput1 == null) || (aOutput1 == null || Materials.get("Graphite").contains(aInput1))) {
            return false;
        }
    ...
    public boolean addCutterRecipe(ItemStack aInput, ItemStack aOutput1, ItemStack aOutput2, int aDuration, int aEUt) {
        ...
        GT_Recipe.GT_Recipe_Map.sCutterRecipes.addRecipe(true, new ItemStack[]{aInput}, new ItemStack[]{aOutput1, aOutput2}, null, new FluidStack[]{Materials.get("Water").getFluid(Math.max(4, Math.min(1000, aDuration * aEUt / 320)))}, null, aDuration * 2, aEUt, 0);
        ...
        GT_Recipe.GT_Recipe_Map.sCutterRecipes.addRecipe(true, new ItemStack[]{aInput}, new ItemStack[]{aOutput1, aOutput2}, null, new FluidStack[]{Materials.get("Lubricant").getFluid(Math.max(1, Math.min(250, aDuration * aEUt / 1280)))}, null, aDuration, aEUt, 0);
        return true;
    }
    ...
    public boolean addAssemblerRecipe(ItemStack aInput1, ItemStack aInput2, FluidStack aFluidInput, ItemStack aOutput1, int aDuration, int aEUt) {
        ...
        GT_Recipe.GT_Recipe_Map.sAssemblerRecipes.addRecipe(true, new ItemStack[]{aInput1, (ItemStack) (aInput2 == null ? new ItemStack[]{aInput1} : aInput2)}, new ItemStack[]{aOutput1}, null, new FluidStack[]{aFluidInput}, null, aDuration, aEUt, 0);
        return true;
    }
...
//    return true;
    ...
    public boolean addAmplifier(ItemStack aAmplifierItem, int aDuration, int aAmplifierAmountOutputted) {
        ...
        GT_Recipe.GT_Recipe_Map.sAmplifiers.addRecipe(true, new ItemStack[]{aAmplifierItem}, null, null, null, new FluidStack[]{Materials.get("UUAmplifier").getFluid(aAmplifierAmountOutputted)}, aDuration, 32, 0);
        return true;
    }
    ...
    public boolean addFluidSolidifierRecipe(ItemStack aMold, FluidStack aInput, ItemStack aOutput, int aDuration, int aEUt) {
        ...
        if (aInput.isFluidEqual(Materials.get("PhasedGold").getMolten(FLUID_MATERIAL_UNIT))) {
            aInput = Materials.get("VibrantAlloy").getMolten(aInput.amount);
        }
        if (aInput.isFluidEqual(Materials.get("PhasedIron").getMolten(FLUID_MATERIAL_UNIT))) {
            aInput = Materials.get("PulsatingIron").getMolten(aInput.amount);
        }
    ...
    public boolean addFluidSmelterRecipe(ItemStack aInput, ItemStack aRemains, FluidStack aOutput, int aChance, int aDuration, int aEUt) {
        ...
        if (aOutput.isFluidEqual(Materials.get("PhasedGold").getMolten(1))) {
            aOutput = Materials.get("VibrantAlloy").getMolten(aOutput.amount);
        }
        if (aOutput.isFluidEqual(Materials.get("PhasedIron").getMolten(1))) {
            aOutput = Materials.get("PulsatingIron").getMolten(aOutput.amount);
        }
    ...
    public boolean addArcFurnaceRecipe(ItemStack aInput, ItemStack[] aOutputs, int[] aChances, int aDuration, int aEUt) {
        ...
        for (ItemStack tStack : aOutputs) {
            if (tStack != null) {
                ...
                GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes.addRecipe(true, new ItemStack[]{aInput}, aOutputs, null, aChances, new FluidStack[]{Materials.get("Oxygen").getGas(aDuration)}, null, Math.max(1, aDuration), Math.max(1, aEUt), 0);
                for (Materials tMaterial : new Materials[]{Materials.get("Argon"), Materials.get("Nitrogen")}) {
                    if (tMaterial.getPlasma() != null) {
