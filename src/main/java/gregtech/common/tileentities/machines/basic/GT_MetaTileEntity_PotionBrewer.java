    ...
    public int checkRecipe() {
        ...
        if ((getDrainableStack() == null) && (aFluid != null) && (getInputAt(0) != null)) {
            ...
            if (tInputName.startsWith("potion.")) {
                ...
                if (GT_Utility.areStacksEqual(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Glowstone"), 1L), getInputAt(0))) {
                ...
                if (GT_Utility.areStacksEqual(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Redstone"), 1L), getInputAt(0))) {
                    if (!tModifier.startsWith("long")) {
                ...
                if (GT_Utility.areStacksEqual(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Gunpowder"), 1L), getInputAt(0))) {
