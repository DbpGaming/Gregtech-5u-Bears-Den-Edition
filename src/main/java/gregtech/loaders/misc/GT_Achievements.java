...
public class GT_Achievements {
    ...
    public GT_Achievements() {
        ...
        registerAchievement("flintpick", 0, 0, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(2, 1, Materials.get("Flint"), Materials.get("Wood"), null), EMPTY_STRING, false);
        ...
        registerAchievement("tools", 0, 4, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(12, 1, Materials.get("Iron"), Materials.get("Wood"), null), "flintpick", false);
        registerAchievement("driltime", 2, 4, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(100, 1, Materials.get("BlueSteel"), Materials.get("StainlessSteel"), null), "tools", false);
        registerAchievement("brrrr", 2, 6, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(110, 1, Materials.get("BlueSteel"), Materials.get("StainlessSteel"), null), "driltime", false);
        registerAchievement("highpowerdrill", 3, 5, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(104, 1, Materials.get("TungstenSteel"), Materials.get("TungstenSteel"), null), "driltime", false);
        registerAchievement("hammertime", 3, 7, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(130, 1, Materials.get("TungstenSteel"), Materials.get("TungstenSteel"), null), "highpowerdrill", false);
        registerAchievement("repair", 4, 5, ItemList.Machine_HV_Disassembler.get(1), "highpowerdrill", false);

        registerAchievement("unitool", -2, 4, GT_MetaGenerated_Tool_01.INSTANCE.getToolWithStats(32, 1, Materials.get("Steel"), Materials.get("Iron"), null), "tools", false);
        registerAchievement("recycling", -4, 4, ItemList.Machine_LV_ArcFurnace.get(1), "unitool", false);

        registerAchievement("crushed", 0, 6, GT_OreDictUnificator.get(OrePrefixes.crushed, Materials.get("Tin"), 1L), "tools", false);
        registerAchievement("cleandust", 0, 10, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Redstone"), 1L), "crushed", false);
        registerAchievement("washing", -2, 6, GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.get("Iron"), 1L), "crushed", false);
        registerAchievement("spinit", -4, 6, GT_OreDictUnificator.get(OrePrefixes.crushedCentrifuged, Materials.get("Redstone"), 1L), "crushed", false);
        registerAchievement("newfuel", -4, 8, ItemList.ThoriumCell_4.get(1), "spinit", false);
        registerAchievement("newmetal", -4, 10, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Lutetium"), 1L), "newfuel", false);
        registerAchievement("reflect", -2, 9, ItemList.Neutron_Reflector.get(1), "newfuel", false);

        registerAchievement("bronze", 2, 0, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Bronze"), 1L), "flintpick", false);
        ...
        registerAchievement("steel", 4, 0, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Steel"), 1L), "bronze", false);
        ...
        registerAchievement("complexalloys", 6, 3, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("BlueSteel"), 1L), "cheapermac", false);

        registerAchievement("magneticiron", 4, -2, GT_OreDictUnificator.get(OrePrefixes.stick, Materials.get("IronMagnetic"), 1L), "steel", false);
        ...
        registerAchievement("gtaluminium", 8, 0, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Aluminium"), 1L), "steel", false);
        ...
        registerAchievement("titan", 10, 0, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Titanium"), 1L), "gtaluminium", false);
        ...
        registerAchievement("muchsteam", 12, 1, ItemList.LargeSteamTurbine.get(1), "titan", false);
        ...
        registerAchievement("tungsten", 16, 0, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Tungsten"), 1L), "upgrade", false);
        ...
        registerAchievement("alienpower", 14, -4, ItemList.Generator_Naquadah_Mark_I.get(1), "hightech", false);
        ...
        registerAchievement("tungstensteel", 14, 6, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("TungstenSteel"), 1L), "upgrade2", false);
        ...
        registerAchievement("advancing", 12, 8, ItemList.FusionComputer_ZPMV.get(1), "fusion", false);
        registerAchievement("tothelimit", 12, 10, ItemList.Generator_Plasma_LuV.get(1), "advancing", false);
        registerAchievement("denseaspossible", 10, 10, ItemList.FusionComputer_UV.get(1), "tothelimit", false);
...
//		}
    ...
    public void issueAchivementHatch(EntityPlayer player, ItemStack stack) {
        ...
        if (data != null) {
            if (data.mPrefix == OrePrefixes.ingot) {
                if (data.mMaterial.mMaterial == Materials.get("Aluminium")) {
                    issueAchievement(player, "gtaluminium");
                } else if (data.mMaterial.mMaterial == Materials.get("Titanium")) {
                    issueAchievement(player, "titan");
                } else if (data.mMaterial.mMaterial == Materials.get("BlueSteel")) {
                    issueAchievement(player, "complexalloys");
                } else if (data.mMaterial.mMaterial == Materials.get("Tungsten")) {
                    issueAchievement(player, "tungsten");
                } else if (data.mMaterial.mMaterial == Materials.get("TungstenSteel")) {
    ...
    public void onCrafting(ItemCraftedEvent event) {
        ...
        ItemData data = GT_OreDictUnificator.getItemData(stack);
        if (data != null) {
            if (data.mPrefix == OrePrefixes.dust && data.mMaterial.mMaterial == Materials.get("Bronze")) {
                issueAchievement(player, "bronze");
            } else if (data.mPrefix == OrePrefixes.circuit && data.mMaterial.mMaterial == Materials.get("Advanced")) {
...
//		System.out.println("Pickup: "+stack.getUnlocalizedName());
        ...
        if (data != null) {
            if (data.mPrefix == OrePrefixes.dust) {
                if (data.mMaterial.mMaterial == Materials.get("Lutetium")) {
                ...
                for (int i = 0; i < data.getAllMaterialStacks().size(); i++) {
                    ...
                    if (data.getAllMaterialStacks().get(i).mMaterial == Materials.get("AnyIron")) {
            ...
            } else if (data.mMaterial.mMaterial == Materials.get("Steel")) {
