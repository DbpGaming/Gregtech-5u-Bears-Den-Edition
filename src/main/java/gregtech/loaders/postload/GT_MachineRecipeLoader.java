...
import static gregtech.api.enums.GT_Values.MOD_ID_TMa;
import static gregtech.api.enums.GT_Values.MOD_ID_TTi;
...
public class GT_MachineRecipeLoader
    ...
    private static void printerRecipes() {
    ...
    private static void fluidSolidifierRecipes() {
    ...
    private static void fluidExtractionRecipes() {
    ...
    private static void fluidSmelterRecipes() {
    ...
    private static void slicerRecipes() {
    ...
    private static void centrifugeRecipes() {
        ...
        if (Loader.isModLoaded(MOD_ID_TF)) {
    ...
    private static void formingPressRecipes() {
    ...
    private static void brewingRecipes() {
    ...
    private static void fermentingRecipes() {
    ...
    private static void extractionRecipes() {
    ...
    private static void compressionRecipes() {
        if (Loader.isModLoaded(MOD_ID_EBXL)) {
    ...
    private static void cutterRecipes() {
        ...
        if (Loader.isModLoaded(MOD_ID_BC_TRANSPORT)) {
    ...
    private static void pulverisationRecipes() {
        if (Loader.isModLoaded(MOD_ID_AE)) {
        ...
        if (Loader.isModLoaded(MOD_ID_HEE)) {
            GT_ModHandler.addPulverisationRecipe(GT_ModHandler.getModItem(MOD_ID_HEE, "endium_ore", 1), GT_OreDictUnificator.get(OrePrefixes.crushed, Materials.get("Endium"), 2), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Endstone"), 1), 50, NULL_ITEM_STACK, 0, true);
        }
    }

    private static void forgeHammerRecipes() {
        ...
        RECIPE_ADDER_INSTANCE.addForgeHammerRecipe(GT_ModHandler.getModItem(MOD_ID_HEE, "endium_ore", 1), GT_OreDictUnificator.get(OrePrefixes.crushed, Materials.get("Endium"), 1), 16, 10);
    }

    private static void amplifierRecipes() {
    ...
    private static void boxingRecipes() {
    ...
    private static void blastRecipes() {
    ...
    private static void cannerRecipes() {
    ...
    private static void pyrolyseRecipes() {
    ...
    private static void hydroFarmRecipes() {
    ...
    private static void fuels() {
        ...
        if (Loader.isModLoaded(MOD_ID_FM)) {
        ...
        if (Loader.isModLoaded(MOD_ID_TMa)) {
            RECIPE_ADDER_INSTANCE.addFuel(GT_ModHandler.getModItem(MOD_ID_TMa, "WarpedShard", 1L), null, 720, 5);
            RECIPE_ADDER_INSTANCE.addFuel(GT_ModHandler.getModItem(MOD_ID_TMa, "FluxShard", 1L), null, 720, 5);
            RECIPE_ADDER_INSTANCE.addFuel(GT_ModHandler.getModItem(MOD_ID_TMa, "EldritchShard", 1L), null, 720, 5);
        }
        if (Loader.isModLoaded(MOD_ID_TTi)) {
            RECIPE_ADDER_INSTANCE.addFuel(GT_ModHandler.getModItem(MOD_ID_TTi, "kamiResource", 1L, 6), null, 720, 5);
            RECIPE_ADDER_INSTANCE.addFuel(GT_ModHandler.getModItem(MOD_ID_TTi, "kamiResource", 1L, 7), null, 720, 5);
        }
        RECIPE_ADDER_INSTANCE.addFuel(new ItemStack(Items.golden_apple, 1, 1), new ItemStack(Items.apple, 1), 640000, 5);
    }

    private static void roasterRecipes() {
    ...
    private static void alloySmelterRecipes() {
        ...
        for (MaterialStack[] tMats : sAlloySmelterList) {
    ...
    private static void partsFactoryRecipes() {
        /* Part Factory */
    ...
    private static void thaumcraftCompatRecipes() {
