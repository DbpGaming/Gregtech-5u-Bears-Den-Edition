...
public class GT_ItemIterator
    ...
    public void run() {
        ...
        ItemStack tStack2;
        ItemStack tStack;
        if (null != (tStack = GT_ModHandler.getRecipeOutput(tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Bronze"), 1L), tStack2, tStack2, tStack2, null, tStack2, tStack2, tStack2, tStack2))) {
            GT_ModHandler.addPulverisationRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Bronze"), 8L), null, 0, false);
            GT_ModHandler.addSmeltingRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Bronze"), 8L));
        }
        if (null != (tStack = GT_ModHandler.getRecipeOutput(tStack2 = GT_OreDictUnificator.get(OrePrefixes.plate, Materials.get("Bronze"), 1L), tStack2, tStack2, tStack2, null, tStack2, tStack2, tStack2, tStack2))) {
            GT_OreDictUnificator.registerOre(OreDictNames.craftingRawMachineTier00, tStack);
            GT_ModHandler.addPulverisationRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Bronze"), 8L), null, 0, false);
            GT_ModHandler.addSmeltingRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Bronze"), 8L));
        }
        ItemStack tStack3;
        if (null != (tStack = GT_ModHandler.getRecipeOutput(tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Iron"), 1L), tStack3 = new ItemStack(Blocks.glass, 1, 0), tStack2, tStack3, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Gold"), 1L), tStack3, tStack2, tStack3, tStack2))) {
            GT_ModHandler.addPulverisationRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Iron"), 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Gold"), 1L), 0, false);
        }
        if (null != (tStack = GT_ModHandler.getRecipeOutput(tStack2 = GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Steel"), 1L), tStack3 = new ItemStack(Blocks.glass, 1, 0), tStack2, tStack3, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.get("Gold"), 1L), tStack3, tStack2, tStack3, tStack2))) {
            GT_ModHandler.addPulverisationRecipe(tStack, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Steel"), 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get("Gold"), 1L), 0, false);
        }
            ...
            if (((tObject = tIterator.next()) != null) && ((tObject instanceof Item)) && (!(tObject instanceof GT_Generic_Item))) {
                ...
                if ((tName = tItem.getUnlocalizedName()) != null) {
                    ...
                    if (tName.equals("tile.ArsMagica:ore_vinteum")) {
                        GT_OreDictUnificator.set(OrePrefixes.ore, Materials.get("Vinteum"), new ItemStack(tItem, 1, 0));
                    }
                    ...
                    if (tName.equals("item.ligniteCoal")) {
                        GT_OreDictUnificator.set(OrePrefixes.gem, Materials.get("Lignite"), new ItemStack(tItem, 1, 0));
                    }
                    if ((tName.equals("tile.extrabiomes.redrock")) || (tName.equals("tile.bop.redRocks"))) {
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Redrock"), new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Redrock"), new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Redrock"), new ItemStack(tItem, 1, 2));
                    }
                    if (tName.equals("tile.rpstone")) {
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Marble"), new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Marble"), new ItemStack(tItem, 1, 2));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 3));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 4));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 5));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 6));
                    }
                    if ((tName.equals("tile.sedimentaryStone")) || ((tName.equals("tile.igneousStone")) || (tName.equals("tile.igneousStoneBrick")) || (tName.equals("tile.igneousCobblestone")))) {
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("GraniteRed"), new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("GraniteBlack"), new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Rhyolite"), new ItemStack(tItem, 1, 2));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Andesite"), new ItemStack(tItem, 1, 3));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Gabbro"), new ItemStack(tItem, 1, 4));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 5));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Komatiite"), new ItemStack(tItem, 1, 6));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Dacite"), new ItemStack(tItem, 1, 7));

                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("GraniteRed"), new ItemStack(tItem, 1, 8));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("GraniteBlack"), new ItemStack(tItem, 1, 9));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Rhyolite"), new ItemStack(tItem, 1, 10));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Andesite"), new ItemStack(tItem, 1, 11));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Gabbro"), new ItemStack(tItem, 1, 12));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Basalt"), new ItemStack(tItem, 1, 13));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Komatiite"), new ItemStack(tItem, 1, 14));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Dacite"), new ItemStack(tItem, 1, 15));
                    }
                    if ((tName.equals("tile.metamorphicStone")) || (tName.equals("tile.metamorphicStoneBrick")) || (tName.equals("tile.metamorphicCobblestone"))) {
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Gneiss"), new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Eclogite"), new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Marble"), new ItemStack(tItem, 1, 2));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Quartzite"), new ItemStack(tItem, 1, 3));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Blueschist"), new ItemStack(tItem, 1, 4));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Greenschist"), new ItemStack(tItem, 1, 5));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Soapstone"), new ItemStack(tItem, 1, 6));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Migmatite"), new ItemStack(tItem, 1, 7));

                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Gneiss"), new ItemStack(tItem, 1, 8));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Eclogite"), new ItemStack(tItem, 1, 9));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Marble"), new ItemStack(tItem, 1, 10));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Quartzite"), new ItemStack(tItem, 1, 11));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Blueschist"), new ItemStack(tItem, 1, 12));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Greenschist"), new ItemStack(tItem, 1, 13));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Soapstone"), new ItemStack(tItem, 1, 14));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Migmatite"), new ItemStack(tItem, 1, 15));
                    }
                    if (tName.equals("tile.blockCosmeticSolid")) {
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Obsidian"), new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator.registerOre(OrePrefixes.stone, Materials.get("Obsidian"), new ItemStack(tItem, 1, 1));
                    }
