            ...
            if (!aOreDictName.equals("itemCertusQuartz")) {
                ...
                if (!aOreDictName.equals("itemNetherQuartz")) {
                    ...
                    if (aOreDictName.equals("itemSilicon")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Silicon"), MATERIAL_UNIT));
                        ...
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Wheat"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemManganese")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Manganese"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemSalt")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Salt"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemMagnesium")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Magnesium"), MATERIAL_UNIT));
                    } else if ((aOreDictName.equals("itemPhosphorite")) || (aOreDictName.equals("itemPhosphorus"))) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Phosphorus"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemSulfur")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Sulfur"), MATERIAL_UNIT));
                    } else if ((aOreDictName.equals("itemAluminum")) || (aOreDictName.equals("itemAluminium"))) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Aluminium"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemSaltpeter")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Saltpeter"), MATERIAL_UNIT));
                    } else if (aOreDictName.equals("itemUranium")) {
                        GT_OreDictUnificator.addItemData(aStack, new ItemData(Materials.get("Uranium"), MATERIAL_UNIT));
                    } else {
