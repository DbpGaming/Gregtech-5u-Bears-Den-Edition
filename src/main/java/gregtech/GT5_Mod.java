...
implements IGT_Mod {
	...
	public void onPreLoad(FMLPreInitializationEvent aEvent) {
		...
		gregtechproxy.mAxeWhenAdventure = tMainConfig.get("general", "AdventureModeStartingAxe", false).getBoolean(false);
		...
		gregtechproxy.mSortToTheEnd = tMainConfig.get("general", "EnsureToBeLoadedLast", false).getBoolean(false);
